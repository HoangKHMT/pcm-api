        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Team1_Player2Id = table.Column<int>(type: "int", nullable: false),
                    Team2_Player1Id = table.Column<int>(type: "int", nullable: false),
                    Team2_Player2Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Matches_Challenges_ChallengeId1",
                        column: x => x.ChallengeId1,
                        principalTable: "Challenges",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team1_Player1Id",
                        column: x => x.Team1_Player1Id,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team1_Player2Id",
                        column: x => x.Team1_Player2Id,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team2_Player1Id",
                        column: x => x.Team2_Player1Id,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Matches_Members_Team2_Player2Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Participants_Members_MemberId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Matches_ChallengeId1",
                table: "Matches",
                column: "ChallengeId1");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_Team1_Player1Id",
                table: "Matches",
                column: "Team1_Player1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_Team1_Player2Id",
                table: "Matches",
                column: "Team1_Player2Id");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_Team2_Player1Id",
                table: "Matches",
                column: "Team2_Player1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_Team2_Player2Id",
                table: "Matches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Participants_MemberId1",
                table: "Participants",
                column: "MemberId1");
